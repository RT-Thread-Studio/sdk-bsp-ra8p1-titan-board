...
#define BSP_CFG_PLL_MUL BSP_CLOCKS_PLL_MUL(200,0) /* PLL Mul x200-219|Mul x200|PLL Mul x200.00 */
#define BSP_CFG_PLL_FREQUENCY_HZ (1600000000) /* PLL 1600000000Hz */
#define BSP_CFG_PLODIVP (BSP_CLOCKS_PLL_DIV_2) /* PLL1P Div /2 */
#define BSP_CFG_PLL1P_FREQUENCY_HZ (800000000) /* PLL1P 800000000Hz */
#define BSP_CFG_PLODIVQ (BSP_CLOCKS_PLL_DIV_2) /* PLL1Q Div /2 */
#define BSP_CFG_PLL1Q_FREQUENCY_HZ (800000000) /* PLL1Q 800000000Hz */
#define BSP_CFG_PLODIVR (BSP_CLOCKS_PLL_DIV_2) /* PLL1R Div /2 */
#define BSP_CFG_PLL1R_FREQUENCY_HZ (800000000) /* PLL1R 800000000Hz */
...
#define BSP_CFG_PL2ODIVP (BSP_CLOCKS_PLL_DIV_3) /* PLL2P Div /3 */
#define BSP_CFG_PLL2P_FREQUENCY_HZ (800000000) /* PLL2P 800000000Hz */
#define BSP_CFG_PL2ODIVQ (BSP_CLOCKS_PLL_DIV_2) /* PLL2Q Div /2 */
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (1200000000) /* PLL2Q 1200000000Hz */
