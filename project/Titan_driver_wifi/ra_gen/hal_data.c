...
#endif
  .ipl = (10),
  .channel = 1, .p_callback = g_sdmmc1_dmac_callback, .p_context = &g_sdmmc1_ctrl, .activation_source =
...
/* Actual period: 21.47483648 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x100000000,
